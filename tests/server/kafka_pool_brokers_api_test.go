...
func TestPoolBrokersKafkaTaskSchedulingSimple(t *testing.T) {
	...
	kafkaPool := []byte(`{"pool_name":"pool","topic_name":"queue_simple","broker":"kafka"}`)
...
func TestPoolBrokersKafkaManyWrites(t *testing.T) {
	...
	kafkaPool := []byte(`{"pool_name":"pool","topic_name":"queue_manywrites","broker":"kafka"}`)
...
func TestPoolBrokersKafkaFloodReads(t *testing.T) {
	...
	kafkaPool := []byte(`{"pool_name":"pool","topic_name":"queue_floodreads","broker":"kafka"}`)
